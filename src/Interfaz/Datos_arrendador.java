...
public class Datos_arrendador extends javax.swing.JFrame {
    ...
    public Datos_arrendador(ArrendadorM arrendadorM) {
        initComponents();
        setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 570, 221, 70));
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/7. Consultar arrendatario 3.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Datos_arrendador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Datos_arrendador().setVisible(true);
            }
        });
    }
